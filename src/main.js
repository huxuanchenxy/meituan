...
let curl =
  "curl 'https://api.day.app/${BarkId}/美团买菜有 蔬菜 请尽快下单?sound=minuet'"
    ...
    setTimeout(function () {
      request(options, function (error, response) {
        ...
        try {
          ...
          //   })
          // ) {
          //   console.log('🎉 恭喜 发现 美团 可用的配送时段 请尽快下单!')
          //   //child_process.exec(curl)

          // } else {
          //   console.log('美团 当前无可用配送时段 15秒后再试...')
          // }
        } catch (err) {
...
async function loop() {
  ...
  // while (true) {
  //   await checkMultiReserveTime(60 * 1000)
  // }
}
